            ...
            <section class="row padding_top">
                ...
                <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <ul class="text_right tooltip_hover">
                                    <li data-toggle="tooltip" title data-original-title="Box"></li>
                                    <li class="active"  data-toggle="tooltip" title data-original-title="List"></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    @if(count($property) > 0)
                        ...
                        @else
                        <div align="center"><h2 style="color: red">No Record Found</h2></div>
                    @endif
